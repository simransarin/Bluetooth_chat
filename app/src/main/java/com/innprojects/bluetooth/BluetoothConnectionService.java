package com.innprojects.bluetooth;
        ...
        public void run() {
            ...
            while (true) {
                ...
                try {
                    ...
                    String result = (String) incomingMessage;
                    resultbuilder.append(result);
                    //int startOfLineIndex = resultbuilder.indexOf("~");
                    //int endOfLineIndex = resultbuilder.indexOf("#");
                    String dataInPrint = resultbuilder.toString();
//                  String dataInPrint = resultbuilder.substring(startOfLineIndex, endOfLineIndex);
                    Intent incomingMessageIntent = new Intent("incomingMessage");
                    incomingMessageIntent.putExtra("theMessage", dataInPrint);
                    Log.d(TAG, "InputStream: " + dataInPrint);
